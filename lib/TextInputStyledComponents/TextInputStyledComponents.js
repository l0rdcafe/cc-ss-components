...
function TextInput(_ref) {
  ...
  var Input = _styledComponents2.default.input(_templateObject2, error && "1px solid red");
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(Input, Object.assign({ id: htmlId, type: type, name: name, placeholder: placeholder, value: value, onChange: onChange }, props)),
    children,
