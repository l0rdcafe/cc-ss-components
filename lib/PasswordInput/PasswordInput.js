...
var PasswordInput = function (_React$Component) {
    ...
    function PasswordInput(props) {
        ...
        _this.toggleShowPassword = function (e) {
    ...
    _createClass(PasswordInput, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                props = _objectWithoutProperties(_props, ["htmlId", "value", "label", "error", "onChange", "placeholder", "minLength", "maxLength", "showVisibilityToggle", "quality"]);
            ...
            return _react2.default.createElement(
                _TextInput2.default,
                Object.assign({ htmlId: htmlId, label: label, placeholder: placeholder, type: showPassword ? "text" : "password", onChange: onChange, value: value, maxLength: maxLength, minLength: minLength, error: error, required: true }, props),
                showVisibilityToggle && _react2.default.createElement(
                    "a",
                    { href: "", onClick: this.toggleShowPassword, style: { marginLeft: 5 } },
